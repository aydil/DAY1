...
public class BMIServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int weight = Integer.parseInt(request.getParameter("weightTextBox"));
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<p>Your weight is =" + weight +" KG </p>");
            out.println("<p>Your weight is =" + height +" M </p>");
            out.println("<p>Your BMI is =" + bmi +"  </p>");
            out.println("<p>You are " + message +"  </p>");
